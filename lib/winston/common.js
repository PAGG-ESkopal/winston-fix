...
exports.log = function (options) {
  ...
  // create metaText from meta (data)
  ...
  if (meta !== null && meta !== undefined) {
    ...
    if (typeof meta !== 'object') {
      options.metaText += ' ' + meta;
    }
    else if (Object.keys(meta).length > 0) {
      if (typeof options.prettyPrint === 'function') {
        options.metaText += ' ' + options.prettyPrint(meta);
        ...
        delete meta.stack;
        delete meta.trace;
        options.metaText += ' ' + exports.serialize(meta);
        options.metaText += '\n' + stack.join('\n');
      } else {
        options.metaText += ' ' + exports.serialize(meta);
      }
